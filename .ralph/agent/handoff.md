...
- [x] zKill CLI args contract + defaults
- [x] zKill ship-type pagination ordering + cursor
- [x] Header-aware retry/backoff policy
- [x] Normalize fitted destroyed+dropped modules
- [x] Deterministic dedupe by killmailId + fitHash
